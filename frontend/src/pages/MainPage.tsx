...
export default class MainPage extends Page
{
    ...
    return (
      <div>
        ...
        <div className="mainExplanationText">
          My good buddy ol' pal CrusherNotDrip decided to make a website about him, so he wouldn't need to cram his about-me in every social media site
          possible. I thought that was a genius idea, so I decided I was gonna{"  "}<span className="thickStrike">steal</span>{"  "}
  ...
  RandomGreeting(): JSX.Element | null
  {
    ...
    if (!greetingList || greetingList.length < 1)
    {
      return <Fragment />;
    }
